...
/// </summary>
/// <remarks>
/// Client code must implement this interface as a <see cref="EfCoreDataContext" /> object factory
/// and add it to a DI container with a scope lifecycle.
/// </remarks>
public interface IEfCoreDataContextProvider : IDataContextProvider, ITransient<IEfCoreDataContextProvider>, IDisposable
{
	/// <summary>
...
/// </summary>
public class EfCoreDataContext : DataContext, IEfCoreDataContext
{
	public EfCoreDataContext(DbContext context, string dataContextName = "default", IReadOnlyDictionary<string, object?>? args = null)
		: base(context, dataContextName, args)
	{
	}
}

public class EfCoreDataContextModel : IModel, IDisposable
{
	private DbContext _dbContext;

	public EfCoreDataContextModel(DbContext dbContext)
	{
...
public static class ExtensionsFoEfCoreDataContext
{
	/// <summary>
