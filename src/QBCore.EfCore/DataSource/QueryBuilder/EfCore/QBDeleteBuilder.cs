...
internal sealed class QBDeleteBuilder<TDoc, TDto> : QBCommonBuilder<TDoc, TDto>, IQBEfCoreDeleteBuilder<TDoc, TDto>
	where TDoc : class
{
	...
	IQBEfCoreDeleteBuilder<TDoc, TDto> IQBEfCoreDeleteBuilder<TDoc, TDto>.Delete(string? tableName)
	{
		AddContainer(tableName, ContainerTypes.Table, ContainerOperations.Delete);
		return this;
	}

	IQBEfCoreDeleteBuilder<TDoc, TDto> IQBEfCoreDeleteBuilder<TDoc, TDto>.Condition(Expression<Func<TDoc, object?>> field, object? constValue, FO operation)
	{
		AddCondition(QBConditionFlags.OnConst, field, constValue, null, operation);
		return this;
	}
	IQBEfCoreDeleteBuilder<TDoc, TDto> IQBEfCoreDeleteBuilder<TDoc, TDto>.Condition(Expression<Func<TDoc, object?>> field, FO operation, string paramName)
	{
		AddCondition(QBConditionFlags.OnParam, field, null, paramName, operation);
		return this;
	}

	IQBEfCoreDeleteBuilder<TDoc, TDto> IQBEfCoreDeleteBuilder<TDoc, TDto>.Begin()
	{
		Begin();
		return this;
	}
	IQBEfCoreDeleteBuilder<TDoc, TDto> IQBEfCoreDeleteBuilder<TDoc, TDto>.End()
	{
		End();
		return this;
	}

	IQBEfCoreDeleteBuilder<TDoc, TDto> IQBEfCoreDeleteBuilder<TDoc, TDto>.And()
	{
		And();
		return this;
	}
	IQBEfCoreDeleteBuilder<TDoc, TDto> IQBEfCoreDeleteBuilder<TDoc, TDto>.Or()
	{
		Or();
		return this;
	}
