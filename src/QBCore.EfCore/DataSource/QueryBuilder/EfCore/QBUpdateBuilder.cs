...
internal sealed class QBUpdateBuilder<TDoc, TDto> : QBCommonBuilder<TDoc, TDto>, IQBEfCoreUpdateBuilder<TDoc, TDto> where TDoc : class
{
	...
	IQBEfCoreUpdateBuilder<TDoc, TDto> IQBEfCoreUpdateBuilder<TDoc, TDto>.Update(string? tableName)
	{
		AddContainer(tableName, ContainerTypes.Table, ContainerOperations.Update);
		return this;
	}

	IQBEfCoreUpdateBuilder<TDoc, TDto> IQBEfCoreUpdateBuilder<TDoc, TDto>.Condition(Expression<Func<TDoc, object?>> field, object? constValue, FO operation)
	{
		AddCondition(QBConditionFlags.OnConst, field, constValue, null, operation);
		return this;
	}
	IQBEfCoreUpdateBuilder<TDoc, TDto> IQBEfCoreUpdateBuilder<TDoc, TDto>.Condition(Expression<Func<TDoc, object?>> field, FO operation, string paramName)
	{
		AddCondition(QBConditionFlags.OnParam, field, null, paramName, operation);
		return this;
	}

	IQBEfCoreUpdateBuilder<TDoc, TDto> IQBEfCoreUpdateBuilder<TDoc, TDto>.Begin()
	{
		Begin();
		return this;
	}
	IQBEfCoreUpdateBuilder<TDoc, TDto> IQBEfCoreUpdateBuilder<TDoc, TDto>.End()
	{
		End();
		return this;
	}

	IQBEfCoreUpdateBuilder<TDoc, TDto> IQBEfCoreUpdateBuilder<TDoc, TDto>.And()
	{
		And();
		return this;
	}
	IQBEfCoreUpdateBuilder<TDoc, TDto> IQBEfCoreUpdateBuilder<TDoc, TDto>.Or()
	{
		Or();
		return this;
	}
