...
internal sealed class RestoreQBBuilder<TDoc, TRestore> : CommonQBBuilder<TDoc, TRestore>, IEfCoreRestoreQBBuilder<TDoc, TRestore> where TDoc : class
{
	...
	IEfCoreRestoreQBBuilder<TDoc, TRestore> IEfCoreRestoreQBBuilder<TDoc, TRestore>.AutoBuild(string? tableName)
	{
		AutoBuild(tableName);
		return this;
	}
	...
	IEfCoreRestoreQBBuilder<TDoc, TRestore> IEfCoreRestoreQBBuilder<TDoc, TRestore>.Update(string? tableName)
	{
		AddContainer(tableName, ContainerTypes.Table, ContainerOperations.Update);
		return this;
	}

	IEfCoreRestoreQBBuilder<TDoc, TRestore> IEfCoreRestoreQBBuilder<TDoc, TRestore>.Condition(Expression<Func<TDoc, object?>> field, object? constValue, FO operation)
	{
		AddCondition(QBConditionFlags.OnConst, field, constValue, null, operation);
		return this;
	}
	IEfCoreRestoreQBBuilder<TDoc, TRestore> IEfCoreRestoreQBBuilder<TDoc, TRestore>.Condition(Expression<Func<TDoc, object?>> field, FO operation, string paramName)
	{
		AddCondition(QBConditionFlags.OnParam, field, null, paramName, operation);
		return this;
	}

	IEfCoreRestoreQBBuilder<TDoc, TRestore> IEfCoreRestoreQBBuilder<TDoc, TRestore>.Begin()
	{
		Begin();
		return this;
	}
	IEfCoreRestoreQBBuilder<TDoc, TRestore> IEfCoreRestoreQBBuilder<TDoc, TRestore>.End()
	{
		End();
		return this;
	}

	IEfCoreRestoreQBBuilder<TDoc, TRestore> IEfCoreRestoreQBBuilder<TDoc, TRestore>.And()
	{
		And();
		return this;
	}
	IEfCoreRestoreQBBuilder<TDoc, TRestore> IEfCoreRestoreQBBuilder<TDoc, TRestore>.Or()
	{
		Or();
		return this;
	}
