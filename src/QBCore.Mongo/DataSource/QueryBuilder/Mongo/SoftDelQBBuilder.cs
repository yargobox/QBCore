...
internal sealed class SoftDelQBBuilder<TDoc, TDelete> : CommonQBBuilder<TDoc, TDelete>, IMongoSoftDelQBBuilder<TDoc, TDelete>
{
	...
	IMongoSoftDelQBBuilder<TDoc, TDelete> IMongoSoftDelQBBuilder<TDoc, TDelete>.AutoBuild(string? tableName)
	{
		AutoBuild(tableName);
		return this;
	}
	...
	IMongoSoftDelQBBuilder<TDoc, TDelete> IMongoSoftDelQBBuilder<TDoc, TDelete>.Update(string? tableName)
	{
		AddContainer(tableName, ContainerTypes.Table, ContainerOperations.Update);
		return this;
	}

	IMongoSoftDelQBBuilder<TDoc, TDelete> IMongoSoftDelQBBuilder<TDoc, TDelete>.Condition(Expression<Func<TDoc, object?>> field, object? constValue, FO operation)
	{
		AddCondition(QBConditionFlags.OnConst, field, constValue, null, operation);
		return this;
	}
	IMongoSoftDelQBBuilder<TDoc, TDelete> IMongoSoftDelQBBuilder<TDoc, TDelete>.Condition(Expression<Func<TDoc, object?>> field, FO operation, string paramName)
	{
		AddCondition(QBConditionFlags.OnParam, field, null, paramName, operation);
		return this;
	}

	IMongoSoftDelQBBuilder<TDoc, TDelete> IMongoSoftDelQBBuilder<TDoc, TDelete>.Begin()
	{
		Begin();
		return this;
	}
	IMongoSoftDelQBBuilder<TDoc, TDelete> IMongoSoftDelQBBuilder<TDoc, TDelete>.End()
	{
		End();
		return this;
	}

	IMongoSoftDelQBBuilder<TDoc, TDelete> IMongoSoftDelQBBuilder<TDoc, TDelete>.And()
	{
		And();
		return this;
	}
	IMongoSoftDelQBBuilder<TDoc, TDelete> IMongoSoftDelQBBuilder<TDoc, TDelete>.Or()
	{
		Or();
		return this;
	}
