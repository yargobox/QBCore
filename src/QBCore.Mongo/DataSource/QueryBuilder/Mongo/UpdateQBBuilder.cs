...
internal sealed class UpdateQBBuilder<TDoc, TUpdate> : CommonQBBuilder<TDoc, TUpdate>, IMongoUpdateQBBuilder<TDoc, TUpdate>
{
	...
	IMongoUpdateQBBuilder<TDoc, TUpdate> IMongoUpdateQBBuilder<TDoc, TUpdate>.AutoBuild(string? tableName)
	{
		AutoBuild(tableName);
		return this;
	}
	...
	IMongoUpdateQBBuilder<TDoc, TUpdate> IMongoUpdateQBBuilder<TDoc, TUpdate>.Update(string? tableName)
	{
		AddContainer(tableName, ContainerTypes.Table, ContainerOperations.Update);
		return this;
	}

	IMongoUpdateQBBuilder<TDoc, TUpdate> IMongoUpdateQBBuilder<TDoc, TUpdate>.Condition(Expression<Func<TDoc, object?>> field, object? constValue, FO operation)
	{
		AddCondition(QBConditionFlags.OnConst, field, constValue, null, operation);
		return this;
	}
	IMongoUpdateQBBuilder<TDoc, TUpdate> IMongoUpdateQBBuilder<TDoc, TUpdate>.Condition(Expression<Func<TDoc, object?>> field, FO operation, string paramName)
	{
		AddCondition(QBConditionFlags.OnParam, field, null, paramName, operation);
		return this;
	}

	IMongoUpdateQBBuilder<TDoc, TUpdate> IMongoUpdateQBBuilder<TDoc, TUpdate>.Begin()
	{
		Begin();
		return this;
	}
	IMongoUpdateQBBuilder<TDoc, TUpdate> IMongoUpdateQBBuilder<TDoc, TUpdate>.End()
	{
		End();
		return this;
	}

	IMongoUpdateQBBuilder<TDoc, TUpdate> IMongoUpdateQBBuilder<TDoc, TUpdate>.And()
	{
		And();
		return this;
	}
	IMongoUpdateQBBuilder<TDoc, TUpdate> IMongoUpdateQBBuilder<TDoc, TUpdate>.Or()
	{
		Or();
		return this;
	}
