...
internal abstract class SqlCommonQBBuilder<TDoc, TDto> : QBBuilder<TDoc, TDto>
{
	...
	public SqlCommonQBBuilder() { }
	public SqlCommonQBBuilder(SqlCommonQBBuilder<TDoc, TDto> other) : base(other)
	{
	...
	protected SqlCommonQBBuilder<TDoc, TDto> AddContainer(string? dbSideName, ContainerTypes containerType, ContainerOperations containerOperation)
	{
	...
	protected SqlCommonQBBuilder<TDoc, TDto> AddCondition(
