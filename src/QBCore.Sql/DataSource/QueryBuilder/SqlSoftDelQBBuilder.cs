...
internal abstract class SqlSoftDelQBBuilder<TDoc, TDelete> : SqlCommonQBBuilder<TDoc, TDelete>, ISqlSoftDelQBBuilder<TDoc, TDelete> where TDoc : class
{
	...
	ISqlSoftDelQBBuilder<TDoc, TDelete> ISqlSoftDelQBBuilder<TDoc, TDelete>.Update(string? tableName)
	{
		AddContainer(tableName, ContainerTypes.Table, ContainerOperations.Update);
		return this;
	}

	ISqlSoftDelQBBuilder<TDoc, TDelete> ISqlSoftDelQBBuilder<TDoc, TDelete>.Condition(Expression<Func<TDoc, object?>> field, object? constValue, FO operation)
	{
		AddCondition(QBConditionFlags.OnConst, field, constValue, null, operation);
		return this;
	}
	ISqlSoftDelQBBuilder<TDoc, TDelete> ISqlSoftDelQBBuilder<TDoc, TDelete>.Condition(Expression<Func<TDoc, object?>> field, FO operation, string paramName)
	{
		AddCondition(QBConditionFlags.OnParam, field, null, paramName, operation);
		return this;
	}

	ISqlSoftDelQBBuilder<TDoc, TDelete> ISqlSoftDelQBBuilder<TDoc, TDelete>.Begin()
	{
		Begin();
		return this;
	}
	ISqlSoftDelQBBuilder<TDoc, TDelete> ISqlSoftDelQBBuilder<TDoc, TDelete>.End()
	{
		End();
		return this;
	}

	ISqlSoftDelQBBuilder<TDoc, TDelete> ISqlSoftDelQBBuilder<TDoc, TDelete>.And()
	{
		And();
		return this;
	}
	ISqlSoftDelQBBuilder<TDoc, TDelete> ISqlSoftDelQBBuilder<TDoc, TDelete>.Or()
	{
		Or();
		return this;
	}
