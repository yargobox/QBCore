...
internal abstract class SqlSelectQBBuilder<TDoc, TSelect> : QBBuilder<TDoc, TSelect>, ISqlSelectQBBuilder<TDoc, TSelect> where TDoc : class
{
	...
	public SqlSelectQBBuilder() { }
	public SqlSelectQBBuilder(SqlSelectQBBuilder<TDoc, TSelect> other) : base(other)
	{
	...
	private SqlSelectQBBuilder<TDoc, TSelect> AddCondition<TLocal, TRef>(
		...
		FO operation)
	{
		return AddCondition<TLocal, TRef>(
			...
			refAlias,
			refField != null ? new DEPath(refField, true, DataLayer) : null,
			constValue,
			paramName,
			operation
		);
...
/* 		if (flags.HasFlag(QBConditionFlags.OnParam))
	...
	private SqlSelectQBBuilder<TDoc, TSelect> AddParameter(string name, Type underlyingType, bool isNullable, System.Data.ParameterDirection direction, Enum dbType)
	{
		...
		{
			IsNormalized = false;
			_parameters.Add(new QBParameter(name, underlyingType, isNullable, direction, dbType));
		}
	...
	private SqlSelectQBBuilder<TDoc, TSelect> AddExclude(DEPathDefinition<TSelect> field, bool optional)
	{
		return AddExclude(field.ToDataEntryPath(DataLayer), optional);
	}
	private SqlSelectQBBuilder<TDoc, TSelect> AddExclude(Expression<Func<TSelect, object?>> field, bool optional)
	{
		return AddExclude(new DEPath(field, false, DataLayer), optional);
	}
	private SqlSelectQBBuilder<TDoc, TSelect> AddExclude(DEPath field, bool optional)
	{
		if (_isByOr != null || _parentheses > 0)
		{
			throw new InvalidOperationException($"Incorrect condition definition of select query builder '{typeof(TSelect).ToPretty()}'.");
	...
	private SqlSelectQBBuilder<TDoc, TSelect> AddSortBy<TLocal>(string? alias, DEPathDefinition<TLocal> field, SO sortOrder)
	{
		return AddSortBy<TLocal>(alias, field.ToDataEntryPath(DataLayer), sortOrder);
	}
	private SqlSelectQBBuilder<TDoc, TSelect> AddSortBy<TLocal>(string? alias, Expression<Func<TLocal, object?>> field, SO sortOrder)
	{
		return AddSortBy<TLocal>(alias, new DEPath(field, false, DataLayer), sortOrder);
	}
	private SqlSelectQBBuilder<TDoc, TSelect> AddSortBy<TLocal>(string? alias, DEPath field, SO sortOrder)
	{
		if (field == null)
		{
			throw new ArgumentNullException(nameof(field));
	...
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Select(string? tableName, string? alias)
		=> AddContainer(typeof(TDoc), alias, tableName, ContainerTypes.Table, ContainerOperations.Select);
	...
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.LeftJoin<TRef>(string? tableName, string? alias)
		=> AddContainer(typeof(TRef), alias, tableName, ContainerTypes.Table, ContainerOperations.LeftJoin);
	...
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Join<TRef>(string? tableName, string? alias)
		=> AddContainer(typeof(TRef), alias, tableName, ContainerTypes.Table, ContainerOperations.Join);
	...
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.CrossJoin<TRef>(string? tableName, string? alias)
		=> AddContainer(typeof(TRef), alias, tableName, ContainerTypes.Table, ContainerOperations.CrossJoin);
	...
	public override QBBuilder<TDoc, TSelect> Connect<TLocal, TRef>(DEPathDefinition<TLocal> field, DEPathDefinition<TRef> refField, FO operation)
		=> AddCondition<TLocal, TRef>(QBConditionFlags.IsConnect | QBConditionFlags.OnField, null, field, null, refField, null, null, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Connect<TLocal, TRef>(Expression<Func<TLocal, object?>> field, Expression<Func<TRef, object?>> refField, FO operation)
		=> AddCondition<TLocal, TRef>(QBConditionFlags.IsConnect | QBConditionFlags.OnField, null, field, null, refField, null, null, operation);
	...
	public override QBBuilder<TDoc, TSelect> Connect<TLocal, TRef>(string alias, DEPathDefinition<TLocal> field, string refAlias, DEPathDefinition<TRef> refField, FO operation)
		=> AddCondition<TLocal, TRef>(QBConditionFlags.IsConnect | QBConditionFlags.OnField, alias, field, refAlias, refField, null, null, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Connect<TLocal, TRef>(string alias, Expression<Func<TLocal, object?>> field, string refAlias, Expression<Func<TRef, object?>> refField, FO operation)
		=> AddCondition<TLocal, TRef>(QBConditionFlags.IsConnect | QBConditionFlags.OnField, alias, field, refAlias, refField, null, null, operation);
	...
	public override QBBuilder<TDoc, TSelect> Connect<TLocal>(DEPathDefinition<TLocal> field, object? constValue, FO operation)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.IsConnect | QBConditionFlags.OnConst, null, field, null, null, constValue, null, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Connect<TLocal>(Expression<Func<TLocal, object?>> field, object? constValue, FO operation)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.IsConnect | QBConditionFlags.OnConst, null, field, null, null, constValue, null, operation);
	...
	public override QBBuilder<TDoc, TSelect> Connect<TLocal>(string alias, DEPathDefinition<TLocal> field, object? constValue, FO operation)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.IsConnect | QBConditionFlags.OnConst, alias, field, null, null, constValue, null, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Connect<TLocal>(string alias, Expression<Func<TLocal, object?>> field, object? constValue, FO operation)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.IsConnect | QBConditionFlags.OnConst, alias, field, null, null, constValue, null, operation);
	...
	public override QBBuilder<TDoc, TSelect> Connect<TLocal>(DEPathDefinition<TLocal> field, FO operation, string paramName)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.IsConnect | QBConditionFlags.OnParam, null, field, null, null, null, paramName, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Connect<TLocal>(Expression<Func<TLocal, object?>> field, FO operation, string paramName)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.IsConnect | QBConditionFlags.OnParam, null, field, null, null, null, paramName, operation);
	...
	public override QBBuilder<TDoc, TSelect> Connect<TLocal>(string alias, DEPathDefinition<TLocal> field, FO operation, string paramName)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.IsConnect | QBConditionFlags.OnParam, alias, field, null, null, null, paramName, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Connect<TLocal>(string alias, Expression<Func<TLocal, object?>> field, FO operation, string paramName)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.IsConnect | QBConditionFlags.OnParam, alias, field, null, null, null, paramName, operation);
	...
	public override QBBuilder<TDoc, TSelect> Condition<TLocal, TRef>(DEPathDefinition<TLocal> field, DEPathDefinition<TRef> refField, FO operation)
		=> AddCondition<TLocal, TRef>(QBConditionFlags.OnField, null, field, null, refField, null, null, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Condition<TLocal, TRef>(Expression<Func<TLocal, object?>> field, Expression<Func<TRef, object?>> refField, FO operation)
		=> AddCondition<TLocal, TRef>(QBConditionFlags.OnField, null, field, null, refField, null, null, operation);
	...
	public override QBBuilder<TDoc, TSelect> Condition<TLocal, TRef>(string alias, DEPathDefinition<TLocal> field, string refAlias, DEPathDefinition<TRef> refField, FO operation)
		=> AddCondition<TLocal, TRef>(QBConditionFlags.OnField, alias, field, refAlias, refField, null, null, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Condition<TLocal, TRef>(string alias, Expression<Func<TLocal, object?>> field, string refAlias, Expression<Func<TRef, object?>> refField, FO operation)
		=> AddCondition<TLocal, TRef>(QBConditionFlags.OnField, alias, field, refAlias, refField, null, null, operation);
	...
	public override QBBuilder<TDoc, TSelect> Condition<TLocal>(DEPathDefinition<TLocal> field, object? constValue, FO operation)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.OnConst, null, field, null, null, constValue, null, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Condition<TLocal>(Expression<Func<TLocal, object?>> field, object? constValue, FO operation)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.OnConst, null, field, null, null, constValue, null, operation);
	...
	public override QBBuilder<TDoc, TSelect> Condition<TLocal>(string alias, DEPathDefinition<TLocal> field, object? constValue, FO operation)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.OnConst, alias, field, null, null, constValue, null, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Condition<TLocal>(string alias, Expression<Func<TLocal, object?>> field, object? constValue, FO operation)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.OnConst, alias, field, null, null, constValue, null, operation);
	...
	public override QBBuilder<TDoc, TSelect> Condition<TLocal>(DEPathDefinition<TLocal> field, FO operation, string paramName)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.OnParam, null, field, null, null, null, paramName, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Condition<TLocal>(Expression<Func<TLocal, object?>> field, FO operation, string paramName)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.OnParam, null, field, null, null, null, paramName, operation);
	...
	public override QBBuilder<TDoc, TSelect> Condition<TLocal>(string alias, DEPathDefinition<TLocal> field, FO operation, string paramName)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.OnParam, alias, field, null, null, null, paramName, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Condition<TLocal>(string alias, Expression<Func<TLocal, object?>> field, FO operation, string paramName)
		=> AddCondition<TLocal, NotSupported>(QBConditionFlags.OnParam, alias, field, null, null, null, paramName, operation);
	...
	public override QBBuilder<TDoc, TSelect> Condition(DEPathDefinition<TDoc> field, object? constValue, FO operation)
		=> AddCondition<TDoc, NotSupported>(QBConditionFlags.OnConst, null, field, null, null, constValue, null, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Condition(Expression<Func<TDoc, object?>> field, object? constValue, FO operation)
		=> AddCondition<TDoc, NotSupported>(QBConditionFlags.OnConst, null, field, null, null, constValue, null, operation);
	...
	public override QBBuilder<TDoc, TSelect> Condition(DEPathDefinition<TDoc> field, FO operation, string paramName)
		=> AddCondition<TDoc, NotSupported>(QBConditionFlags.OnParam, null, field, null, null, null, paramName, operation);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Condition(Expression<Func<TDoc, object?>> field, FO operation, string paramName)
		=> AddCondition<TDoc, NotSupported>(QBConditionFlags.OnParam, null, field, null, null, null, paramName, operation);

	public override QBBuilder<TDoc, TSelect> Begin()
	{
		((ISqlSelectQBBuilder<TDoc, TSelect>)this).Begin();
		return this;
	}
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Begin()
	{
		IsNormalized = false;
		_parentheses++;
		_sumParentheses++;
	...
	{
		((ISqlSelectQBBuilder<TDoc, TSelect>)this).End();
		return this;
	}
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.End()
	{
	...
	{
		((ISqlSelectQBBuilder<TDoc, TSelect>)this).And();
		return this;
	}
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.And()
	{
		if (_isByOr != null || _parentheses > 0 || _conditions == null || _conditions.Count == 0)
		{
			throw new InvalidOperationException($"Incorrect condition definition of select query builder '{typeof(TSelect).ToPretty()}'.");
	...
	{
		((ISqlSelectQBBuilder<TDoc, TSelect>)this).Or();
		return this;
	}
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Or()
	{
		if (_isByOr != null || _parentheses > 0 || _conditions == null || _conditions.Count == 0)
		{
			throw new InvalidOperationException($"Incorrect condition definition of select query builder '{typeof(TSelect).ToPretty()}'.");
	...
	public override QBBuilder<TDoc, TSelect> Include<TRef>(DEPathDefinition<TSelect> field, DEPathDefinition<TRef> refField)
		=> AddInclude<TRef>(field, null, refField);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Include<TRef>(Expression<Func<TSelect, object?>> field, Expression<Func<TRef, object?>> refField)
		=> AddInclude<TRef>(field, null, refField);
	...
	public override QBBuilder<TDoc, TSelect> Include<TRef>(DEPathDefinition<TSelect> field, string refAlias, DEPathDefinition<TRef> refField)
		=> AddInclude<TRef>(field, refAlias, refField);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Include<TRef>(Expression<Func<TSelect, object?>> field, string refAlias, Expression<Func<TRef, object?>> refField)
		=> AddInclude<TRef>(field, refAlias, refField);
	...
	public override QBBuilder<TDoc, TSelect> Exclude(DEPathDefinition<TSelect> field)
		=> AddExclude(field, false);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Exclude(Expression<Func<TSelect, object?>> field)
		=> AddExclude(field, false);
	...
	public override QBBuilder<TDoc, TSelect> Optional(DEPathDefinition<TSelect> field)
		=> AddExclude(field, true);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.Optional(Expression<Func<TSelect, object?>> field)
		=> AddExclude(field, true);
	...
	public override QBBuilder<TDoc, TSelect> SortBy(DEPathDefinition<TSelect> field, SO sortOrder = SO.Ascending)
		=> AddSortBy(null, field, sortOrder);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.SortBy(Expression<Func<TSelect, object?>> field, SO sortOrder)
		=> AddSortBy(null, field, sortOrder);
	...
	public override QBBuilder<TDoc, TSelect> SortBy<TLocal>(string alias, DEPathDefinition<TLocal> field, SO sortOrder = SO.Ascending)
		=> AddSortBy(alias, field, sortOrder);
	ISqlSelectQBBuilder<TDoc, TSelect> ISqlSelectQBBuilder<TDoc, TSelect>.SortBy<TLocal>(string alias, Expression<Func<TLocal, object?>> field, SO sortOrder)
		=> AddSortBy(alias, field, sortOrder);
