...
public class QBJoinCondition
{
	public int QBJoinConditionId { get; set; }
	...
	internal class EntityTypeConfiguration : PluralNamingConfiguration<QBJoinCondition>
	{
		public override void Configure(EntityTypeBuilder<QBJoinCondition> builder)
		{
			builder
				.ToTable(ObjectName, SchemaName)
				.HasKey(x => x.QBJoinConditionId);

			builder
				.HasOne(x => x.QueryBuilder)
				.WithMany(x => x.QBJoinConditions)
				.IsRequired()
